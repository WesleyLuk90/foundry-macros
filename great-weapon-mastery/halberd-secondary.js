...
const RegulardSword = "icons/weapons/polearms/speartip-simple-stone.webp";
const SpecialSword = "icons/weapons/polearms/speartip-simple-stone.webp";
...
function title(gwm) {
	...
	<header class="card-header flexrow red-header">
        ...
        }" title="Halberd End" width="36" height="36"/>
